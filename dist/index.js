...
function SectionHeader($$renderer, $$props) {
  ...
  if (count !== void 0) {
    $$renderer.push("<!--[-->");
    $$renderer.push(`<span class="item-count svelte-1lncexq">(${escape_html(count)})</span>`);
  } else {
    $$renderer.push("<!--[!-->");
  }
